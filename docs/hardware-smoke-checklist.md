...
| C8 | The release arrives, and how late | **Green**, late by 2s | Enforcement lifted with the app closed and the domain loaded again, and the history row reads completed. `released late_by_seconds=2` in the archive | None |
